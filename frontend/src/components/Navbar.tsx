      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          {user ? (
                    ...
                    <div className="p-4 space-y-3">
                      ...
                      <div className="rounded-xl bg-slate-50 border border-slate-200 p-3 space-y-1.5">
                        <div className="flex items-center justify-between">
                          <span className="text-[10px] font-extrabold uppercase text-slate-500">Sui Testnet Address</span>
                          <button
                            onClick={copyAddress}
            ...
            <Link
              href="/login"
              className="flex items-center gap-2 rounded-xl bg-white px-4 py-2 text-xs font-bold text-blue-700 shadow-sm hover:bg-blue-50 active:scale-[0.98] transition-all"
            >
