...
const TOUR_STEPS = [
  {
    ...
    desc: 'SuiPact is a zero-gas stablecoin Secure Vault on Sui Testnet. It lets clients and freelancers settle project payments safely — without middlemen or platform fees.',
    role: 'Your Role',
  ...
  },
  {
    ...
    roleDesc: 'Traditional escrow platforms charge 5–20% fees, take days to settle, and require separate payments per person. SuiPact Secure Vault does it in 400ms, $0 cost, for up to 6 recipients.',
  ...
  },
  {
    ...
    title: "You're Ready!",
    desc: "That's the entire SuiPact flow. Head to the Dashboard to see your orders, or create a new Secure Vault now. Your demo personas (Alice/Bob) are pre-funded on Sui Testnet.",
    role: 'Pro Tip',
    roleDesc: 'Log in as Alice Corp (Client) to create and fund a Secure Vault. Then switch to Bob Vance (Freelancer) to submit deliverables.',
    color: 'from-blue-700 to-blue-900',
